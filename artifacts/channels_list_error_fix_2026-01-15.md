...
- При 81 канале клавиатура превышает лимит Telegram
...
- `cc1e70c9-9058-4fd0-9b52-94012623f0e0` - 81 канал (превышает лимит)
- `6af5e7d3-e736-46da-bfc1-42786f2ab1c0` - 55 каналов (превышает лимит)
- `4c5cd5bf-ba90-4e64-87fa-09f59adef1ac` - 51 канал (превышает лимит)

**Исправление**: Теперь все эти пользователи смогут увидеть свои каналы без ошибки
