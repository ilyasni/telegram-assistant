...
Replacement: worker/health_server.py (уже используется в worker/main.py)
...
if os.getenv("ENV") == "production":
    raise ImportError(
        "worker/simple_health_server.py is deprecated and unused. "
        "Use worker/health_server.py instead. "
...
⚠️ DEPRECATED: Use worker/health_server.py instead
"""
