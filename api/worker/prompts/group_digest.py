...
def role_classifier_prompt_v1() -> ChatPromptTemplate:
    ...
    system = dedent(
        ...
        - comment — лаконичное (≤120 символов) пояснение вклада и поведения.
...
def topic_synthesizer_prompt_v1() -> ChatPromptTemplate:
    ...
    system = dedent(
        ...
        - Если темы выделить нельзя, верни одну тему «Общее обсуждение» со статусом watch.
        Ответ строго JSON.
        """
    )
    human = dedent(
        ...
        {{
          "topics": [
            {{
              ...
              "summary": "Коротко опиши исходную ситуацию и ключевые аргументы.",
              "decision": "Обновить клиент до версии 2.3 до пятницы.",
              "status": "in_progress",
              "owners": ["boyversus"],
