    ...
    async def generate(
        ...
        digest = GroupDigest(
            ...
            payload={
                ...
                "prompt_version": orchestrator_state.get("prompt_version", "digest_composer_prompt_v1"),
                "pipeline_version": orchestrator_state.get("pipeline_version", "group_digest_v1"),
                "digest_mode": orchestrator_state.get("digest_mode", "normal"),
            },
